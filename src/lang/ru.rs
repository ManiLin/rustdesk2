...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Exit password required", "Требуется пароль для выхода"),
        ("Enter password to stop service while remote sessions are active", "Есть активные подключения. Введите пароль для остановки службы и закрытия приложения."),
